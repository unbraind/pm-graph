...
- Gate CI on pm health for tracker integrity (does not cover discarded peer edits, see pm-cli 922) ([pm-graph-9qk5](https://github.com/unbraind/pm-graph/blob/main/.agents/pm/chores/pm-graph-9qk5.toon))
