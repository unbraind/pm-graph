...
- A publish that npm accepts late is reported as failed and the GitHub Release is skipped on bun mirror lag ([pm-graph-1k7d](https://github.com/unbraind/pm-graph/blob/main/.agents/pm/issues/pm-graph-1k7d.toon))

### Other

- Certify pm CLI 2026.9.23 and adopt the guarded pm-ops merge-driver launcher ([pm-graph-at6i](https://github.com/unbraind/pm-graph/blob/main/.agents/pm/chores/pm-graph-at6i.toon))
...
- Certify pm CLI 2026.9.10 and pick up the canonical auditor fixes the lockfile was holding back ([pm-graph-upz4](https://github.com/unbraind/pm-graph/blob/main/.agents/pm/chores/pm-graph-upz4.toon))

## 2026.9.8 - 2026-09-08

### Security

- Consume the canonical attestation gate instead of carrying a copy of it ([pm-graph-qg2n](https://github.com/unbraind/pm-graph/blob/main/.agents/pm/chores/pm-graph-qg2n.toon))

### Other

- Harden the attestation consumer suite to match the rest of the converged fleet ([pm-graph-53r2](https://github.com/unbraind/pm-graph/blob/main/.agents/pm/chores/pm-graph-53r2.toon))
...
- Release commits discard the rebuilt dist, so the git-install path serves the previous version ([pm-graph-v6yt](https://github.com/unbraind/pm-graph/blob/main/.agents/pm/issues/pm-graph-v6yt.toon))
